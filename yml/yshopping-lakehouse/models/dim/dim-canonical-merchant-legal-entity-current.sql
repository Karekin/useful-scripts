CREATE OR REPLACE VIEW yshopping_dim.dim_canonical_merchant_legal_entity_current AS
SELECT
    event_id, tenant_id, entity_id AS legal_entity_id, previous_status, current_status,
    aggregate_version, occurred_at, recorded_at, correlation_id, entity_event_count
FROM (
    SELECT event.*,
