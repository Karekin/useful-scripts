CREATE OR REPLACE VIEW yshopping_dwd.dwd_canonical_return_fulfillment_status_event AS
SELECT
    event_id, schema_version, tenant_id, aggregate_id AS return_fulfillment_id, aggregate_version,
...
WHERE event_type = 'return_fulfillment.status.changed'
