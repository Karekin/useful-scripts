...
SELECT event_id, tenant_id, aggregate_id AS ticket_id, aggregate_version, occurred_at, recorded_at,
       ...
       get_json_string(payload, '$.sla_policy_code') AS sla_policy_code,
       CAST(get_json_string(payload, '$.sla_policy_version') AS INT) AS sla_policy_version,
       CAST(get_json_string(payload, '$.resolution_deadline_at') AS DATETIME) AS resolution_deadline_at,
       CAST(get_json_string(payload, '$.fcr_window_hours') AS INT) AS fcr_window_hours,
