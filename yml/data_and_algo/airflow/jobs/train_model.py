...
def run_train_model(execution_date: str):
    ...
    mlflow.set_tracking_uri(uri) # 强制设置，确保生效

    print(f"DEBUG: MLFLOW_S3_ENDPOINT_URL: {os.environ.get('MLFLOW_S3_ENDPOINT_URL')}")

    # 统一 Experiment 名称，方便在 UI 查找
    experiment_name = "StoreReplenishment_Pipeline"
